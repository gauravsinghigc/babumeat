...
<body onload="doConvert()" style="padding:5rem;font-size:14px;color: black;margin:auto;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif !important;">

	<section style="border-style:groove; border-width:thin;margin: auto; width: 900px;border: 1px solid green;padding: 5rem;height:850px;">
		<center>
